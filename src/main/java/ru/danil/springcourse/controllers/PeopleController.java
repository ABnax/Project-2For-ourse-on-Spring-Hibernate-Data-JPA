...
import ru.danil.springcourse.util.PersonValidator;
...
public class PeopleController {
    ...
    public String show(@PathVariable("id") int id, Model model) {
        model.addAttribute("person", peopleService.findForOne(id));
        model.addAttribute("book", bookService.getBooksByPersonId(id));
